        ...
        try:
            ...
            if keyword:
                if keyword["campaign"]["language"] == "vi":
                    try:
                        h = 0
                        for i in search(keyword["keyword"]["Keyword"], tld="com.vn", start=0, num=20, stop=20, pause=1,
                    ...
                    h = 0
                    for i in search(keyword["keyword"]["Keyword"], tld="com", start=0, num=20, stop=20, pause=1,
